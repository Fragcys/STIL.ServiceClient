...
public class ProeveomraadeUddInfoType
{

    private string proeveOmraadeUddIDField;

    private string proeveOmraadeRefField;
    ...
    public string ProeveOmraadeUddID
    {
        get => proeveOmraadeUddIDField; set => proeveOmraadeUddIDField = value;
    }

    /// <remarks/>
    [System.Xml.Serialization.XmlElement(DataType = "positiveInteger", Order = 1)]
    public string ProeveOmraadeRef
    {
        get => proeveOmraadeRefField; set => proeveOmraadeRefField = value;
    }
