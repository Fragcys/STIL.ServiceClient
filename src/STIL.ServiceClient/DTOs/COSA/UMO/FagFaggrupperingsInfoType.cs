...
public class FagFaggrupperingsInfoType
{

    private string fagFaggrupperingIDField;

    private string faggrupperingRefField;
    ...
    public string FagFaggrupperingID
    {
        get => fagFaggrupperingIDField; set => fagFaggrupperingIDField = value;
    }

    /// <remarks/>
    [System.Xml.Serialization.XmlElement(DataType = "positiveInteger", Order = 1)]
    public string FaggrupperingRef
    {
        get => faggrupperingRefField; set => faggrupperingRefField = value;
    }
