...
public class KompetenceFagInfoType
{

    private string kompetenceFagIDField;

    private string kompetenceRefField;
    ...
    public string KompetenceFagID
    {
        get => kompetenceFagIDField; set => kompetenceFagIDField = value;
    }

    /// <remarks/>
    [System.Xml.Serialization.XmlElement(DataType = "positiveInteger", Order = 1)]
    public string KompetenceRef
    {
        get => kompetenceRefField; set => kompetenceRefField = value;
    }
